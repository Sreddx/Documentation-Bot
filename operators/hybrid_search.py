...
class HybridSearch(BaseOperator):
    ...
    def declare_description():
        return 'This operator performs a hybrid search by combining vector similarity search and ChatGPT completion.'
        ...
        return [
            {
                "name": "vector_index",
                "data_type": "{}",
                "description": "The vector index for similarity search."
            }
        ]
        ...
        return [
            {
                ...
                "data_type": "string",
                "description": "The response generated by ChatGPT + Hybrid Search."
            }
        ]
